...
Usage:
    uv load_to_bigquery.py --input ./scraped_data/tvs_20260715_143000.csv --config load/config.yaml
    uv run load/loader.py --input ./scraped_data/ --config load/config.yaml --dry-run
